package com.pos.olympia.Dividers;
...
public class ReceiptDividerDecoration extends RecyclerView.ItemDecoration {
  ...
  public ReceiptDividerDecoration(Context context) {
  ...
  private int getOrientation(RecyclerView parent) {
    ...
    try {
      ...
      throw new IllegalStateException("ReceiptDividerDecoration can only be used with a " +
