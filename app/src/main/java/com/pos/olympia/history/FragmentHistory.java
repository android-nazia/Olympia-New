...
public class FragmentHistory extends Fragment implements View.OnClickListener {
    ...
    private void fetchOrderTable(){
        ...
        String query_doc = "SELECT * FROM OrderTable WHERE CreatedTime BETWEEN datetime('now', '-6 days') AND datetime('now', 'localtime') ORDER BY CreatedTime DESC";
    ...
    private void populateRV(){
        ...
        recyclerView.addItemDecoration(new ReceiptDividerDecoration(getActivity()));

        StickyRecyclerHeadersTouchListener touchListener =
                new StickyRecyclerHeadersTouchListener(recyclerView, headersDecor);

        recyclerView.addOnItemTouchListener(touchListener);
        recyclerView.addOnItemTouchListener(new ReceiptClickListener(getActivity(),
    ...
    public String dateConversion(String date){
        ...
        spf= new SimpleDateFormat("EEE, MMM dd, yy");
        date = spf.format(newDate);
        return date;
    }
